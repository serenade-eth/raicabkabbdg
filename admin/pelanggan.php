                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                          ...
                                          <a href="pelanggan_hapus.php" onclick="return confirm('Yakin hapus data ? ');" data-toggle="tooltip" data-placement="bottom" title="Hapus" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
