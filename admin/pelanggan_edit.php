            ...
            <div class="white-box">
                ...
                <div class="form-group">
                    ...
                    <select name="jenis_kelamin" class="form-control">
                        <option value="PENDING" <?php if($edit['jenis_kelamin']  == 'PENDING'){echo "selected";} ?>>PENDING</option>
                        <option value="DIPROSES" <?php if($edit['jenis_kelamin']  == 'DIPROSES'){echo "selected";} ?>>DIPROSES</option>
                    </select>
                </div>
