        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li>
                        <a class="profile-pic" href="#"> <img src="../assets/plugins/images/users/varun.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">USER</b></a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li style="padding: 70px 0 0;">
                        <a href="index.php" class="waves-effect <?php if($title=='dashboard'){echo 'active';} ?>"><i class="" aria-hidden="true"></i></a>
                    </li>
                    <li>
                        <a href="pendaftar.php" class="waves-effect <?php if($title=='pendaftar'){echo 'active';} ?>"><i class="fa fa-user fa-fw" aria-hidden="true"></i>Pendaftaran</a>
                    </li>
                </ul>
